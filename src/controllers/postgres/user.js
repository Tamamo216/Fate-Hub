...
//     .catch(err => {
//       console.log(err);
//       res.status(200).json({msg: "username not found"});
//     });
// }
...
// function loadProfileEditPage(req,res,next) {
//   const user = req.user;
//   try {
...
// function loadChangePasswordPage(req,res) {
...
//       User.changePassword(username, newHasedPassword)
//         .then(() => {
//           res.status(300).json({
//             code: 2,
